...
func run_client(t *testing.T, cfg *config, me int, ca chan bool, fn func(me int, ck *Clerk, t *testing.T), funcName string) {
	ok := false
	defer func() { ca <- ok }()
	ck := cfg.makeClient(cfg.All(), funcName)
	fn(me, ck, t)
	ok = true
	cfg.deleteClient(ck)
}
...
func spawn_clients_and_wait(t *testing.T, cfg *config, ncli int, fn func(me int, ck *Clerk, t *testing.T), funcName string) {
	ca := make([]chan bool, ncli)
	for cli := 0; cli < ncli; cli++ {
		ca[cli] = make(chan bool)
		go run_client(t, cfg, cli, ca[cli], fn, funcName)
	}
...
func GenericTest(t *testing.T, part string, nclients int, unreliable bool, crash bool, partitions bool, maxraftstate int, funcName string) {
	...
	const nservers = 5
	cfg := make_config(t, nservers, unreliable, maxraftstate, funcName)
	defer cfg.cleanup()
...
func GenericTestLinearizability(t *testing.T, part string, nclients int, nservers int, unreliable bool, crash bool, partitions bool, maxraftstate int, funcName string) {
...
func TestBasic3A(t *testing.T) {
	// Test: one client (3A) ...
	GenericTest(t, "3A", 1, false, false, false, -1, "TestBasic3A")
}

func TestConcurrent3A(t *testing.T) {
	// Test: many clients (3A) ...
	GenericTest(t, "3A", 5, false, false, false, -1, "TestConcurrent3A")
}

func TestUnreliable3A(t *testing.T) {
	// Test: unreliable net, many clients (3A) ...
	GenericTest(t, "3A", 5, true, false, false, -1, "TestUnreliable3A")
}

func TestUnreliableOneKey3A(t *testing.T) {
	const nservers = 3
	cfg := make_config(t, nservers, true, -1, "TestUnreliableOneKey3A")
	defer cfg.cleanup()

	ck := cfg.makeClient(cfg.All(), "TestUnreliableOneKey3A")
...
func TestOnePartition3A(t *testing.T) {
	const nservers = 5
	cfg := make_config(t, nservers, false, -1, "TestOnePartition3A")
	defer cfg.cleanup()
	ck := cfg.makeClient(cfg.All(), "TestOnePartition3A")
	...
	ckp1 := cfg.makeClient(p1, "TestOnePartition3A")  // connect ckp1 to p1
	ckp2a := cfg.makeClient(p2, "TestOnePartition3A") // connect ckp2a to p2
	ckp2b := cfg.makeClient(p2, "TestOnePartition3A") // connect ckp2b to p2
...
func TestManyPartitionsOneClient3A(t *testing.T) {
	...
	GenericTest(t, "3A", 1, false, false, true, -1, "TestManyPartitionsOneClient3A")
}

func TestManyPartitionsManyClients3A(t *testing.T) {
	// Test: partitions, many clients (3A) ...
	GenericTest(t, "3A", 5, false, false, true, -1, "TestManyPartitionsManyClients3A")
}

func TestPersistOneClient3A(t *testing.T) {
	// Test: restarts, one client (3A) ...
	GenericTest(t, "3A", 1, false, true, false, -1, "TestPersistOneClient3A")
}

func TestPersistConcurrent3A(t *testing.T) {
	// Test: restarts, many clients (3A) ...
	GenericTest(t, "3A", 5, false, true, false, -1, "TestPersistConcurrent3A")
}

func TestPersistConcurrentUnreliable3A(t *testing.T) {
	// Test: unreliable net, restarts, many clients (3A) ...
	GenericTest(t, "3A", 5, true, true, false, -1, "TestPersistConcurrentUnreliable3A")
}

func TestPersistPartition3A(t *testing.T) {
	// Test: restarts, partitions, many clients (3A) ...
	GenericTest(t, "3A", 5, false, true, true, -1, "TestPersistPartition3A")
}

func TestPersistPartitionUnreliable3A(t *testing.T) {
	// Test: unreliable net, restarts, partitions, many clients (3A) ...
	GenericTest(t, "3A", 5, true, true, true, -1, "TestPersistPartitionUnreliable3A")
}
...
func TestPersistPartitionUnreliableLinearizable3A(t *testing.T) {
	...
	GenericTestLinearizability(t, "3A", 15, 7, true, true, true, -1, "TestPersistPartitionUnreliableLinearizable3A")
}
...
func TestSnapshotRPC3B(t *testing.T) {
	const nservers = 3
	maxraftstate := 1000
	cfg := make_config(t, nservers, false, maxraftstate, "TestSnapshotRPC3B")
	defer cfg.cleanup()

	ck := cfg.makeClient(cfg.All(), "TestSnapshotRPC3B")
	...
	{
		ck1 := cfg.makeClient([]int{0, 1}, "TestSnapshotRPC3B")
		for i := 0; i < 50; i++ {
	...
	{
		ck1 := cfg.makeClient([]int{0, 2}, "TestSnapshotRPC3B")
		Put(cfg, ck1, "c", "C")
		Put(cfg, ck1, "d", "D")
		check(cfg, t, ck1, "a", "A")
		check(cfg, t, ck1, "b", "B")
...
func TestSnapshotSize3B(t *testing.T) {
	...
	cfg := make_config(t, nservers, false, maxraftstate, "TestSnapshotSize3B")
	defer cfg.cleanup()

	ck := cfg.makeClient(cfg.All(), "TestSnapshotSize3B")
...
func TestSnapshotRecover3B(t *testing.T) {
	...
	GenericTest(t, "3B", 1, false, true, false, 1000, "TestSnapshotRecover3B")
}

func TestSnapshotRecoverManyClients3B(t *testing.T) {
	// Test: restarts, snapshots, many clients (3B) ...
	GenericTest(t, "3B", 20, false, true, false, 1000, "TestSnapshotRecoverManyClients3B")
}

func TestSnapshotUnreliable3B(t *testing.T) {
	// Test: unreliable net, snapshots, many clients (3B) ...
	GenericTest(t, "3B", 5, true, false, false, 1000, "TestSnapshotUnreliable3B")
}

func TestSnapshotUnreliableRecover3B(t *testing.T) {
	// Test: unreliable net, restarts, snapshots, many clients (3B) ...
	GenericTest(t, "3B", 5, true, true, false, 1000, "TestSnapshotUnreliableRecover3B")
}

func TestSnapshotUnreliableRecoverConcurrentPartition3B(t *testing.T) {
	// Test: unreliable net, restarts, partitions, snapshots, many clients (3B) ...
	GenericTest(t, "3B", 5, true, true, true, 1000, "TestSnapshotUnreliableRecoverConcurrentPartition3B")
}
...
func TestSnapshotUnreliableRecoverConcurrentPartitionLinearizable3B(t *testing.T) {
	...
	GenericTestLinearizability(t, "3B", 15, 7, true, true, true, 1000, "TestSnapshotUnreliableRecoverConcurrentPartitionLinearizable3B")
}
